...
class RecordPatternHelper {
    ...
    /**
     * Because {@link JCPatternCaseLabel#pat} type is {@link JCPattern}, we need to
     * delay access to an inner class. <br>
    ...
    static JCExpression getAnyPatternType(JCTree label) {
        ...
        try {
            ...
            if (type instanceof JCExpression) {
    ...
    /**
     * Collect a record declaration for later component name lookup.
     * Call during tree traversal.
     */
     ...
     */
    void extractRecordBindings(
            List<? extends JCTree> nested, JCExpression baseAccessor,
