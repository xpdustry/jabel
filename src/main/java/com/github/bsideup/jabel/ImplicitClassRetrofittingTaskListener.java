...
/**
 * The implicit flag is removed and class become final. <br>
 * Make a synthetic package-protected no-args constructor, and make everything private. <br>
 * This will not throw the right error, but will protect against instances and references. <br>
 * This is not perfect but better than nothing.
 * <p>
 * Solutions to adapt implicit classes:
 * <ul>
 *   <li>
 *      Make everything static, and add {@code String[] args} to existing main.
 *   </li>
 *   <li>
 *     Just create a static main. Since JWM distinguish local and static method, this will not be a problem. <br>
 *     But will probably cause error when decompiling or debugging.
 *   </li>
 *   <li>
 *     Same as previous, but rename any existing main methods and it's references. <br>
 *     But will probably cause other problems when trying to reference it, or other problems when debugging.
 *   </li>
 * </ul>
 */
